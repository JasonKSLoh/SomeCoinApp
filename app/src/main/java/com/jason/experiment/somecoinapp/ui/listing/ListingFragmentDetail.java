...
/**
 * ListingFragmentDetail
 * Created by jason.
 */
public class ListingFragmentDetail extends Fragment {
    ...
    private void bindObservers() {
        ...
        listingViewModel.getSelectedCoin().observe(getParentFragment(), selectedCoinObserver);

        Observer<Boolean> followButtonObserver = b -> {
            if (b == null) {
                return;
            }
            int coinId = listingViewModel.getSelectedCoin().getValue().getId();
            if(isCoinFollowed()){
        ...
        listingViewModel.getFollowButtonPressed().observe(getParentFragment(), followButtonObserver);
    }
    ...
    private void bindViews(View view) {
        ...
        btnFollow.setOnClickListener(v -> {
            listingViewModel.onFollowButtonPressed();
        });
    ...
    private boolean isCoinFollowed(){
        ...
        TickerDatum selectedDatum = listingViewModel.getSelectedCoin().getValue();
