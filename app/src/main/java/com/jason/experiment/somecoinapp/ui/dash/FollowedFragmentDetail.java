...
/**
 * FollowedFragmentDetail
 * Created by jason.
 */
public class FollowedFragmentDetail extends Fragment {
    ...
    private void bindObservers() {
        ...
        followedViewModel.getSelectedCoin().observe(getParentFragment(), selectedCoinObserver);

        Observer<Boolean> followButtonObserver = b -> {
            if (b == null) {
                return;
            }
            int coinId = followedViewModel.getSelectedCoin().getValue().getId();
            if(isCoinFollowed()){
        ...
        followedViewModel.getFollowButtonPressed().observe(getParentFragment(), followButtonObserver);
    }
    ...
    private void bindViews(View view) {
        ...
        btnFollow.setOnClickListener(v -> {
            followedViewModel.onFollowButtonPressed();
        });
    ...
    private boolean isCoinFollowed(){
        ...
        TickerDatum        selectedDatum = followedViewModel.getSelectedCoin().getValue();
